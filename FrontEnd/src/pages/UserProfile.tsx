...
export const UserProfile = () => {
  ...
  return <div className="flex flex-col min-h-screen bg-transparent w-full relative">
        ...
        <main className="flex-1 p-8">
          ...
          {activeSection === 'vendor' && user?.role !== 'VENDOR' && (
            <div className="max-w-4xl">
              ...
              <p className="text-gray-400 mb-8">
                Fill out the form below to apply to become a vendor. Your application will be reviewed by our admin team.
              </p>
              ...
              <form onSubmit={handleVendorSubmit} className="space-y-6">
                ...
                <div className="flex justify-end">
                  <button 
                    ...
                    className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white py-3 px-8 rounded-lg font-medium transition-colors"
                  >
          ...
          {activeSection === 'vendor' && user?.role === 'VENDOR' && (
            <div className="max-w-6xl space-y-8">
              <div>
                ...
                <p className="text-gray-400 mb-8">
                  Update your vendor information and manage your packages.
                </p>
              </div>
              ...
              {vendorLoading ? (
                <div className="text-center py-8 text-gray-400">Loading vendor data...</div>
              ) : vendor ? (
                <>
                  {/* Vendor Update Form */}
                  <div className="bg-gray-800 bg-opacity-50 border border-gray-700 rounded-lg p-6">
                    <h2 className="text-2xl font-bold text-white mb-6">Vendor Information</h2>
                    <form onSubmit={handleVendorUpdate} className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <label className="block text-white mb-2">Main Photo URL</label>
                          <input 
                            type="url" 
                        ...
                        <div>
                          <label className="block text-white mb-2">Detail Photo URL</label>
                          <input 
                            type="url" 
                  ...
                  <div className="bg-gray-800 bg-opacity-50 border border-gray-700 rounded-lg p-6">
                    ...
                    <form onSubmit={handlePackageSubmit} className="mb-8 space-y-6 bg-gray-900/50 p-6 rounded-lg">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          <label className="block text-white mb-2">Package Name <span className="text-red-400">*</span></label>
                          <input 
                            type="text" 
                            name="packageName"
                        ...
                        <div>
                          <label className="block text-white mb-2">Price <span className="text-red-400">*</span></label>
                          <input 
                            type="number" 
                            name="price"
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {packageFormData.features.map((feature, index) => (
                            <span key={index} className="flex items-center gap-2 px-3 py-1 bg-purple-600/20 border border-purple-500 rounded-lg text-white">
                              {feature}
                              <button
                                type="button"
                      ...
                      <div className="flex justify-end">
                        <button 
                          ...
                          className="bg-purple-600 hover:bg-purple-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white py-2 px-6 rounded-lg font-medium transition-colors"
                        >
                      ...
                      {packages.length === 0 ? (
                        ...
                        <div className="space-y-4">
                          {packages.map((pkg: any) => (
                            <div key={pkg.id} className="bg-gray-900/50 border border-gray-700 rounded-lg p-4">
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center gap-3 mb-2">
                                    <h4 className="text-lg font-bold text-white">{pkg.packageName}</h4>
                                    <span className={`text-xs px-2 py-1 rounded ${pkg.isActive ? 'bg-green-600' : 'bg-gray-600'} text-white`}>
                                      {pkg.isActive ? 'Active' : 'Inactive'}
                                    </span>
                                  </div>
                                  <p className="text-gray-300 mb-2">{pkg.description}</p>
                                  <p className="text-purple-400 font-semibold mb-2">Rs. {pkg.price?.toFixed(2) || '0.00'}</p>
                                  {pkg.duration && (
                                    <p className="text-gray-400 text-sm mb-2">Duration: {pkg.duration}</p>
                                  )}
      ...
      <style>{`
        ...
        .profile-section:hover .profile-section-title {
        ...
        .profile-section:hover .profile-section-subtitle {
          color: #c4b5fd;
        }
